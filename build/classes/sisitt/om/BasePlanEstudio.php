...
/**
 * Base class that represents a row from the 'planestudio' table.
 *
 *
 *
 * @package    propel.generator.sisitt.om
 */
abstract class BasePlanEstudio extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'PlanEstudioPeer';
    ...
    /**
     * The value for the nombreplaestudio field.
     * @var        string
     */
    protected $nombreplaestudio;
    ...
    /**
     * Get the [nombreplaestudio] column value.
     *
     * @return string
     */
     ...
     * @return PlanEstudio The current object (for fluent API support)
     */
    public function setIdPlanEstudio($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = PlanEstudioPeer::ID;
        }
    ...
    /**
     * Set the value of [nombreplaestudio] column.
     *
     * @param  string $v new value
     * @return PlanEstudio The current object (for fluent API support)
     */
    public function setNombrePlanEstudio($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->nombreplaestudio !== $v) {
            $this->nombreplaestudio = $v;
            $this->modifiedColumns[] = PlanEstudioPeer::NOMBREPLAESTUDIO;
        }


        return $this;
    } // setNombrePlanEstudio()
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->nombreplaestudio = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->resetModified();
            ...
            return $startcol + 2; // 2 = PlanEstudioPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating PlanEstudio object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = PlanEstudioPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = PlanEstudioQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                PlanEstudioPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PlanEstudioPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(PlanEstudioPeer::NOMBREPLAESTUDIO)) {
            $modifiedColumns[':p' . $index++]  = '`nombreplaestudio`';
        }

        $sql = sprintf(
            'INSERT INTO `planestudio` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`id`':
                        ...
                        break;
                    case '`nombreplaestudio`':
                        $stmt->bindValue($identifier, $this->nombreplaestudio, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = PlanEstudioPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = PlanEstudioPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                return $this->getIdPlanEstudio();
                break;
            case 1:
                return $this->getNombrePlanEstudio();
                break;
            default:
                return null;
                break;
    ...
    {
        if (isset($alreadyDumpedObjects['PlanEstudio'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PlanEstudio'][$this->getPrimaryKey()] = true;
        $keys = PlanEstudioPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdPlanEstudio(),
            $keys[1] => $this->getNombrePlanEstudio(),
        );
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                $this->setIdPlanEstudio($value);
                break;
            case 1:
                $this->setNombrePlanEstudio($value);
                break;
        } // switch()
    }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setIdPlanEstudio($arr[$keys[0]]);
        if (array_key_exists($keys[1], $arr)) $this->setNombrePlanEstudio($arr[$keys[1]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PlanEstudioPeer::ID)) $criteria->add(PlanEstudioPeer::ID, $this->id);
        if ($this->isColumnModified(PlanEstudioPeer::NOMBREPLAESTUDIO)) $criteria->add(PlanEstudioPeer::NOMBREPLAESTUDIO, $this->nombreplaestudio);
    ...
    {
        $criteria = new Criteria(PlanEstudioPeer::DATABASE_NAME);
        $criteria->add(PlanEstudioPeer::ID, $this->id);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getIdPlanEstudio();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of PlanEstudio (or compatible) type.
    ...
    {
        $copyObj->setNombrePlanEstudio($this->getNombrePlanEstudio());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdPlanEstudio(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return PlanEstudio Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return PlanEstudioPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new PlanEstudioPeer();
        }
     ...
     * If this PlanEstudio is new, it will return
    ...
    public function setUsuarios(PropelCollection $usuarios, PropelPDO $con = null)
    {
        ...
        foreach ($usuariosToDelete as $usuarioRemoved) {
            $usuarioRemoved->setPlanEstudio(null);
        }
    ...
    {
        return (string) $this->exportTo(PlanEstudioPeer::DEFAULT_STRING_FORMAT);
    }
