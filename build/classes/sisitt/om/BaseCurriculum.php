...
/**
 * Base class that represents a row from the 'curriculums' table.
 *
 *
 *
...
abstract class BaseCurriculum extends BaseObject implements Persistent
{
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = CurriculumPeer::ID;
        }
    ...
    public function setIdUsuario($v)
    {
        ...
        if ($this->idusuario !== $v) {
            $this->idusuario = $v;
            $this->modifiedColumns[] = CurriculumPeer::IDUSUARIO;
        }
    ...
    public function setDocumento($v)
    {
        ...
        if ($this->documento !== $v) {
            $this->documento = $v;
            $this->modifiedColumns[] = CurriculumPeer::DOCUMENTO;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 3; // 3 = CurriculumPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = CurriculumQuery::create()
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CurriculumPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(CurriculumPeer::IDUSUARIO)) {
            $modifiedColumns[':p' . $index++]  = '`idusuario`';
        }
        if ($this->isColumnModified(CurriculumPeer::DOCUMENTO)) {
            $modifiedColumns[':p' . $index++]  = '`documento`';
        }

        $sql = sprintf(
            'INSERT INTO `curriculums` (%s) VALUES (%s)',
    ...
    {
        if (isset($alreadyDumpedObjects['Curriculum'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Curriculum'][$this->getPrimaryKey()] = true;
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CurriculumPeer::ID)) $criteria->add(CurriculumPeer::ID, $this->id);
        if ($this->isColumnModified(CurriculumPeer::IDUSUARIO)) $criteria->add(CurriculumPeer::IDUSUARIO, $this->idusuario);
        if ($this->isColumnModified(CurriculumPeer::DOCUMENTO)) $criteria->add(CurriculumPeer::DOCUMENTO, $this->documento);
    ...
    {
        $criteria = new Criteria(CurriculumPeer::DATABASE_NAME);
        $criteria->add(CurriculumPeer::ID, $this->id);
    ...
    public function getUsuario(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aUsuario === null && ($this->idusuario !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aUsuario->addCurriculums($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(CurriculumPeer::DEFAULT_STRING_FORMAT);
    }
