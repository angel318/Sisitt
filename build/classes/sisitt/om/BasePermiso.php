...
abstract class BasePermiso extends BaseObject implements Persistent
{
    ...
    public function getAcceso()
    {
        ...
        $valueSet = PermisoPeer::getValueSet(PermisoPeer::ACCESO);
        if (!isset($valueSet[$this->acceso])) {
            throw new PropelException('Unknown stored enum key: ' . $this->acceso);
        }

        return $valueSet[$this->acceso];
    }
    ...
    public function getTipo()
    {
        ...
        $valueSet = PermisoPeer::getValueSet(PermisoPeer::TIPO);
     ...
     * @return Permiso The current object (for fluent API support)
     */
    ...
    public function setIdUsuario($v)
    {
        ...
        if ($this->idusuario !== $v) {
            $this->idusuario = $v;
            $this->modifiedColumns[] = PermisoPeer::IDUSUARIO;
        }
    ...
    public function setModulo($v)
    {
        ...
        if ($this->modulo !== $v) {
            $this->modulo = $v;
            $this->modifiedColumns[] = PermisoPeer::MODULO;
        }
    ...
    public function setAcceso($v)
    {
        ...
        if ($this->acceso !== $v) {
            $this->acceso = $v;
            $this->modifiedColumns[] = PermisoPeer::ACCESO;
        }
    ...
    public function setTipo($v)
    {
        ...
        if ($this->tipo !== $v) {
            $this->tipo = $v;
            $this->modifiedColumns[] = PermisoPeer::TIPO;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->acceso = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
            ...
            return $startcol + 5; // 5 = PermisoPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = PermisoQuery::create()
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PermisoPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(PermisoPeer::IDUSUARIO)) {
            $modifiedColumns[':p' . $index++]  = '`idusuario`';
        }
        if ($this->isColumnModified(PermisoPeer::MODULO)) {
            $modifiedColumns[':p' . $index++]  = '`modulo`';
        }
        if ($this->isColumnModified(PermisoPeer::ACCESO)) {
            $modifiedColumns[':p' . $index++]  = '`acceso`';
        }
        if ($this->isColumnModified(PermisoPeer::TIPO)) {
            $modifiedColumns[':p' . $index++]  = '`tipo`';
        }

        $sql = sprintf(
            'INSERT INTO `permiso` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`idusuario`':
                        ...
                        break;
                    case '`modulo`':
                        $stmt->bindValue($identifier, $this->modulo, PDO::PARAM_STR);
                        break;
                    case '`acceso`':
                        $stmt->bindValue($identifier, $this->acceso, PDO::PARAM_INT);
                        break;
                    case '`tipo`':
    ...
    {
        if (isset($alreadyDumpedObjects['Permiso'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Permiso'][$this->getPrimaryKey()] = true;
        $keys = PermisoPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdPermiso(),
            $keys[1] => $this->getIdUsuario(),
            $keys[2] => $this->getModulo(),
            $keys[3] => $this->getAcceso(),
            $keys[4] => $this->getTipo(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) $this->setAcceso($arr[$keys[3]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PermisoPeer::IDUSUARIO)) $criteria->add(PermisoPeer::IDUSUARIO, $this->idusuario);
        if ($this->isColumnModified(PermisoPeer::MODULO)) $criteria->add(PermisoPeer::MODULO, $this->modulo);
        if ($this->isColumnModified(PermisoPeer::ACCESO)) $criteria->add(PermisoPeer::ACCESO, $this->acceso);
        if ($this->isColumnModified(PermisoPeer::TIPO)) $criteria->add(PermisoPeer::TIPO, $this->tipo);
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdPermiso(NULL); // this is a auto-increment column, so set to default value
        }
    }
    ...
    public function getUsuario(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aUsuario === null && ($this->idusuario !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aUsuario->addPermisos($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(PermisoPeer::DEFAULT_STRING_FORMAT);
    }
